...
type SysAdmin struct {
	...
	Nickname   string     `gorm:"column:nickname;varchar(64);comment:'昵称';NOT NULL" json:"nickname"`           // 昵称
	...
	Phone      string     `gorm:"column:phone;varchar(64);comment:'手机';" json:"phone"`                         // 手机
